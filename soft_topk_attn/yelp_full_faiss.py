...
def parse_args():
    ...
    p.add_argument('--faiss_c', type=float, default=10.0, help='Candidate multiplier: topm ~= learned_k * c (after warmup).')
    ...
    p.add_argument('--faiss_max_cand', type=int, default=2048, help='Cap candidate set size after optional union with k-hop.')
...
def main():
    ...
    if bool(getattr(args, 'use_faiss', False)):
        ...
        print(f"FAISS: warmup_time={warm1:.2f}s rolling_time={roll1:.2f}s")
